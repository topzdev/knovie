      ...
      <div class="footer__main">
        ...
        <ul class="footer__links">
          <li aria-label="links" title="Visit all my project at Github">
            <a
              href="https://github.com/topzdev"
              aria-label="Visit Creator Github Account"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li aria-label="links" title="Hire me at  Upwork">
            <a
              href="https://www.upwork.com/freelancers/~0183563188426b2c0c"
              aria-label="Visit Creator Upword Account"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li aria-label="links" title="Connect me at  Linkedin">
            <a
              href="https://www.linkedin.com/in/christopher-lugod-ba146b197/"
              target="_blank"
              aria-label="Visit Create Linkedin"
              rel="noreferrer"
            >
              <vue-icon :svg="icons.linkedIN" />
            </a>
          </li>

          <li aria-label="links" title="Follow me at facebook">
            <a
              href="https://www.facebook.com/Christoplugod/"
              target="_blank"
              aria-label="Visit Create Facebook"
              rel="noreferrer"
            >
              <vue-icon :svg="icons.facebook" />
            </a>
          </li>

          <li aria-label="links" title="Tweet me at facebook">
            <a
              href="https://twitter.com/_christop_"
              aria-label="Visit Creator Twitter Account"
              target="_blank"
              rel="noreferrer"
            >
              <vue-icon :svg="icons.twitter" />
            </a>
          </li>

          <li aria-label="links" title="Follow me at Instagram">
            <a
              href="https://www.instagram.com/christoplugod/"
              aria-label="Visit Creator Instagram"
              target="_blank"
              rel="noreferrer"
            >
              <vue-icon :svg="icons.instagram" />
            </a>
          </li>
        </ul>
      </div>
