    ...
    <div class="row">
      ...
      >
        ...
        <ul class="movie__info-list">
          <li v-for="net in info.networks" :key="net.id" :title="net.name">
            <img
              :src="imagePath(net.logo_path, 'w300')"
              :alt="net.name"
              class="movie__logo"
              draggable="false"
            />
        ...
        <ul class="movie__info-list">
          <li>
            <p class="paragraph--primary">
              {{ dayjs(info.first_air_date).format("MMMM D, YYYY") }}
            </p>
          </li>
        </ul>
      </div>
      ...
      >
        ...
        <ul class="movie__info-list">
          <li>
            <p class="paragraph--primary">
              {{ dayjs(info.last_air_date).format("MMMM D, YYYY") }}
            </p>
          </li>
        </ul>
      </div>
...
import imagePath from "@/utils/imagePath";import SocialButton from "@/components/button/SocialButton";
import {
  mdiAccountTie,
  mdiCalendarRange,
